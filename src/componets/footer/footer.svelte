...
<div class="h-36 w-full">
  <div class="h-36 w-full flex flex-col items-center">
    <div class="w-10/12 h-0.5 bg-black"></div>
    <div class="w-10/12 h-16 mt-2 flex flex-row">
      <div class="flex flex-row items-center">
        <div>© 2025 James Matheri. All rights reserved.</div>
      </div>
      <div
        class="w-1/12 ml-auto flex flex-row items-center justify-between g-12"
      >
        <div>
          <svg
